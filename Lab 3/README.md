...
![HPOparameters](https://user-images.githubusercontent.com/36265995/103016099-d5609700-4541-11eb-912d-91863c5190e6.png)
...
This job started 20 trainigs jobs in 2 batches (10 jobs per batch). All training jobs within batch will run in paralell. The maximum numebr of 20 training  jobs was configured by use when we started Autopilot processing. 10 training per batch it is a default configuration:
